...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `${SITE_URL}/${locale}/community/volunteers/${slug}`,
      languages: {
        ar: `${SITE_URL}/ar/community/volunteers/${slug}`,
        en: `${SITE_URL}/en/community/volunteers/${slug}`,
      },
    },
    openGraph: {
      type: 'profile',
      url: `${SITE_URL}/${locale}/community/volunteers/${slug}`,
...
export default async function ContributorProfilePage({ params }: Props) {
  ...
  if (!getAllVolunteerSlugs().includes(slug)) notFound();
